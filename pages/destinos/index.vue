<template>
  <div>
    ...
    <section>
        <div class="content">
          <h1 id="title-destinos" class="title26px">{{ this.title }}</h1>
          <ul id="lista-destinos">
            <li class="destino" v-for="destino in data" :key="destino.location">
              <div class="img-wrapper">
                <img class="main-img" :src="destino.location_photo" :alt="destino.location">
              </div>
              <div class="details">
                <ul class="stars">
...
export default {
  ...
  methods: {
    sendDestino(d) {
      console.log(d)
      // this.$router.push({ name: 'Destino': params: { category: 'news' } });
    }
  },
  head() {
    return {
  ...
  async fetch() {
      this.data = await fetch('https://test-desarrollador-front.cclh.io/destinos/')
      .then(res => res.json())
      .catch((e) => {
    ...
    .destino {
      ...
      .img-wrapper {
        ...
        .main-img {
          ...
          height: 184px; /* height of container */
          object-fit: cover;
